        ...
        <div class="center">
            <section class="contentSide">
                ...
                <section class="mainContent">
                    ...
                    <?php
                    $state = get_field('bottom_links_state');
                    if ($state):
                        the_field('bottom_links', 8);
                    endif;
                    ?>
                </section>
                ...
                <?php
                $id_post = get_the_ID();
                if(($id_post == 5862) || $id_post == 2933 || $id_post == 2647 || $id_post == 5889){
                    ?>
                        ...
                        <div class="center">
                            <div class="programs-bottom-items">
                                ...
                                <div class="programs-bottom-content-item">
                                    ...
                                    else if($id_post == 2933){
                                        $result_cat = 219;
                                    }
                                    else if($id_post == 2647){
                                        $result_cat = 199;
                                    }
                                    else if($id_post == 5889){
                                        $result_cat = 213;
                                    }
                                    ?>
                ...
                <section class="blog">
                    ...
                    <div class="articlesWrap">
                        ...
                        //Opiate
                        else if (get_the_ID() == 2933) {
                            $cat_id = 19;
                        }
                        //Alcohol
                        else if (get_the_ID() == 2647) {
                            $cat_id = 21;
                        }
                        //Heroine
                        else if (get_the_ID() == 5889) {
                            $cat_id = 17;
                        }
